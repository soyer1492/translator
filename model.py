...
class Encoder(nn.Module):
    def __init__(self, input_size, hidden_size, layers=4, dropout=0.1, bidirectional=True):
...
class Decoder(nn.Module):
    def __init__(self, hidden_size, output_size, layers=4, dropout=0.1, bidirectional=True):
